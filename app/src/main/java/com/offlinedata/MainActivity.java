            ...
            public void success(MainResponse mainResponse, Response response) {
                ...
                if(mainResponse.getStatus().equalsIgnoreCase("success")){
                    ...
                    for(int i =0;i<listResoponses.size();i++){
                        if(i==0){
                            db.addContact(new Contact(""+listResoponses.get(i).getFirstName(), "http://www.gmm.srl/wp-content/uploads/Logo-G.jpg",listResoponses.get(i).getHomework(), ""+listResoponses.get(i).getClientId()));


                        }
                        else {
                            db.addContact(new Contact(""+listResoponses.get(i).getFirstName(), ""+listResoponses.get(i).getProfilePic(), listResoponses.get(i).getHomework(),""+listResoponses.get(i).getClientId()));
